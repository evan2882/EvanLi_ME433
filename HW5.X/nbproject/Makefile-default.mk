...
SOURCEFILES_QUOTED_IF_SPACED=i2c_blink.c i2c_master_noint.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/i2c_blink.o ${OBJECTDIR}/i2c_master_noint.o
POSSIBLE_DEPFILES=${OBJECTDIR}/i2c_blink.o.d ${OBJECTDIR}/i2c_master_noint.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/i2c_blink.o ${OBJECTDIR}/i2c_master_noint.o

# Source Files
SOURCEFILES=i2c_blink.c i2c_master_noint.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/i2c_blink.o: i2c_blink.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/i2c_blink.o.d 
	@${RM} ${OBJECTDIR}/i2c_blink.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c_blink.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_blink.o.d" -o ${OBJECTDIR}/i2c_blink.o i2c_blink.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/i2c_blink.o: i2c_blink.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/i2c_blink.o.d 
	@${RM} ${OBJECTDIR}/i2c_blink.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c_blink.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_blink.o.d" -o ${OBJECTDIR}/i2c_blink.o i2c_blink.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
