        ...
        case APP_STATE_SCHEDULE_WRITE:
           ...
           /* THIS IS WHERE YOU CAN READ YOUR IMU, PRINT TO THE LCD, ETC */
            if(r_flag == true){
                ...
                zlist[3]=zlist[4];
                zlist[4]=z_bar;
                maf=(zlist[0]+zlist[1]+zlist[2]+zlist[3]+zlist[4])/5;
                fir=0.0338* zlist[0]+0.2401 *zlist[1]+0.4521 *zlist[2]+0.2401 *zlist[3]+0.0338*zlist[4];
                iir=0.7*zlist[3]+0.3*zlist[4];
                
                //len = sprintf(dataOut, " %d %d %d %d %d\r\n", zlist[0], zlist[1], zlist[2], zlist[3],zlist[4]);
