...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            short x_bar, y_bar, gyroX,gyroY, gyroZ, z_bar;
           ...
           /* THIS IS WHERE YOU CAN READ YOUR IMU, PRINT TO THE LCD, ETC */
            if(r_flag == true){
                ...
                gyroY=-Data16[2]/50;
                gyroZ=-Data16[3]/50;      
                x_bar=-Data16[4]/50;        //Data16 is a list, it includes all temperature, gyroX, gyroY, gyroZ, accelX, accelY, accelZ
                y_bar=-Data16[5]/50;
                z_bar=-Data16[6]/50;
                
                len = sprintf(dataOut, "index: %d, x:%d, y:%d, z:%d, gyroX:%d, gyroY: %d, gyroZ: %d\r\n", s, x_bar, y_bar, z_bar, gyroX,gyroY, gyroZ);
